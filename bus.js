...
const shareCodes = [
  {
    zd: "fpgajq2772bidj6gd3a565q4gu",
    nc: "655eac45f37b4950a140dcd1cbadd9ee",
    mc: "MTE1NDQ5MzYwMDAwMDAwMzQzMTk3NjM=",
    dd: "T008aFTclp2UCjVWnYaS5kRrbA",
    jx: "VWh_BfVfiMyfNYcs-hGujA==",
    zz: "SaFTclp2U",
    xj: "9bKYum8_",
   joy: "n4yCZHcbM6w="
  },
  {
    zd: "e6qws4foahaufpdhvt3px3vcyy",
    nc: "ad698bf459934a90aadf161ed547ee73",
    mc: "MTE1NDUyMjEwMDAwMDAwMzU1NzYyMTM=",
    dd: "T012a13YmK219FbUCjVWnYaS5kRrbA",
    jx: "AHx26BTxGaC8GrNEEfw9Og==",
    zz: "Sa13YmK219FbU",
    xj: "9ructF8eZ_4l",
   joy: "V8h1Dqrl1FkYVVxgadlu6w=="
  },
  {
    zd: "d6c2i3idf445xduj3mzqge4jdm",
    nc: "493aa9fd419745dcadf30e1232955d63",
    mc: "MTE1NDQ5OTIwMDAwMDAwMzY4MzA1OTk=",
    dd: "T008aFTclp2UCjVWnYaS5kRrbA",
    jx: "AHx26BTxGaC8GrNEEfw9Og==",
    zz: "SaXfhmJ-vINhn",
    xj: "9JGltG0Es3CW",
   joy: "6XViDU05iLwrKC4w9SlVtQ=="
  },
  {
    zd: "kwcidou4xzd5xlxipjbuwtyabq",
    nc: "b1e358edd9184eabbf1a45c05c256ff3",
    mc: "MTE1NDQ5OTUwMDAwMDAwMzg1NDQ0MzU=",
    dd: "T012a13YmK219FbUCjVWnYaS5kRrbA",
    jx: "pOT8gGAZnGscEO0ZKc9-QQ==",
    zz: "S2Zw1IXk",
    xj: "RHpxDYs",
   joy: "OZgZxh4-XwQ="
  },
...
!(async () => {
  for (let i = 0; i < shareCodes.length; i++) {
    const { zd, nc, mc, dd, jx, zz, xj, joy} = shareCodes[i];
    ...
    xj &&await createXj(`https://code.chiang.fun/api/v1/jd/jdcash/create/${xj}/`)
